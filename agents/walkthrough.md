...
- **Introspection Sources** ([introspection-source.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/introspection/introspection-source.ts)):
...
- **Schema Parsing & Entity Descriptors** ([entity-descriptor.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/schema/entity-descriptor.ts)):
...
- **IRI Utilities** ([iri-utils.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/schema/iri-utils.ts)):
  - Handled opaque API Platform IRI identifiers (e.g. `/api/statuses/1`) without unnecessary base64 decoding.
- **Selection Set Builder** ([selection-set-builder.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/documents/selection-set-builder.ts)):
...
- **Document Factory** ([document-factory.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/documents/document-factory.ts)):
...
- **Dynamic Schema Validator** ([schema-validator.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/validation/schema-validator.ts)):
...
- **Transport & Errors** ([graphql-transport.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/transport/graphql-transport.ts), [errors.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/transport/errors.ts)):
...
- **Repository Pattern** ([create-repository.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-core/src/repository/create-repository.ts)):
...
- **Vue Plugin** ([plugin.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-vue/src/plugin.ts)):
  - `createGraphQLOrm` plugin providing `GRAPHQL_ORM_KEY` context, repository caching, and schema warm-up.
- **Composables** ([use-collection.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-vue/src/composables/use-collection.ts), [use-item.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-vue/src/composables/use-item.ts), [use-entity-mutations.ts](file:///home/alcides/f_d_n/frontend/packages/graphql-orm-vue/src/composables/use-entity-mutations.ts)):
