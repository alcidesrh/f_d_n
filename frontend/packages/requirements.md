...
```typescript
// packages/graphql-orm-vue/src/composables/use-collection.ts
...
// packages/graphql-orm-vue/src/composables/use-collection.ts (firma final, reemplaza el genérico "T" suelto)
