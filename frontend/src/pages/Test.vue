      ...
      >
        <div>
          ...
          <p class="mt-1 text-sm text-neutral-500">
            Venta rápida de boletos y selección visual de asientos
          </p>
        </div>
        ...
        <div class="flex flex-col gap-4">
          ...
          <q-card flat class="rounded-4 shadow-sm">
            <q-card-section class="space-y-4">
              <div
                class="grid grid-cols-1 gap-4 lg:grid-cols-[2fr_auto_auto_auto]"
              >
                <!-- Cliente -->
                <FormKit
                  type="select"
          ...
          <q-card flat class="rounded-4 shadow-sm">
              ...
              <div class="mb-3 flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-neutral-500">
                    Seleccione una salida para ver los asientos
                  </p>
                </div>
              ...
              >
                <template #body-cell-status="props">
                  <q-td :props="props">
                    <q-badge
                      :color="
                        props.value === 'Abordando' ? 'orange' : 'positive'
                      "
                      rounded
                    >
                      {{ props.value }}
            ...
            <div class="grid gap-3 p-3 xl:hidden">
              <q-card
                ...
                :class="
                  selectedTrip[0]?.id === trip.id ? 'ring-2 ring-primary' : ''
                "
              ...
              >
                <q-card-section>
                  <div class="flex items-start justify-between gap-4">
                    ...
                    <q-badge
                      :color="
                        trip.status === 'Abordando' ? 'orange' : 'positive'
                      "
                    >
                      {{ trip.status }}
                    </q-badge>
                  ...
                  <div
                    class="mt-4 grid grid-cols-2 gap-y-2 text-sm text-neutral-600"
                  >
                    <div>
          ...
          <q-card flat class="rounded-4 shadow-sm">
            <q-card-section>
              <div class="mb-4">
                ...
                <p class="text-sm text-neutral-500">
                  Ajuste el abordaje o descenso del pasajero
                </p>
              </div>
              ...
              <q-checkbox
                ...
                label="Utilizar dirección de estación origen"
                class="mt-4"
              />
            ...
            <q-card-section>
              <div class="mb-4 flex items-center justify-between">
                <div>
                  ...
                  <p class="text-sm text-neutral-500">
                    Asientos seleccionados y total
                  </p>
                </div>
        ...
        <aside class="xl:sticky xl:top-4 xl:h-fit">
          <q-card flat class="rounded-4 shadow-sm">
            <q-card-section>
              ...
              <!-- Driver -->
              <div
                class="mb-6 flex h-20 items-center justify-center rounded-3 bg-neutral-100 text-sm font-medium text-neutral-500 dark:bg-neutral-800"
              >
                Conductor
              </div>
              ...
              <div class="grid grid-cols-4 gap-3">
                <button
                  ...
                  :class="[
                    seat.status,
                    selectedSeats.includes(seat.number) ? 'seat-selected' : '',
                  ]"
              ...
              <div class="mt-6 grid grid-cols-2 gap-3 text-sm">
                <div class="flex items-center gap-2">
                  <div
                    class="h-4 w-4 rounded bg-lime-200 ring-1 ring-lime-400"
                  />
                  Disponible
                </div>
                ...
                <div class="flex items-center gap-2">
                  <div
                    class="h-4 w-4 rounded bg-yellow-200 ring-1 ring-yellow-400"
                  />
                  Reservado
                </div>
              </div>
