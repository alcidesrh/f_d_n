          ...
          <FormKit type="form" :actions="false">
            ...
            >
              <template v-slot:body="props">
                <q-tr
                  :props="props"
                  :class="props.row.id === 10 ? 'bg-blue-1' : ''"
                >
                  <q-td
            ...
            <div class="row q-col-gutter-md q-mb-sm">
              ...
              <div class="col-12 col-md-6">
                ...
                <FormKit
                  ...
                  name="baja_en"
                  :options="[
                    { label: 'SEP-Santa Elena, Flores, Peten', value: 'sep' },
                  ]"
                  :context="{ id: 'baja_en' }"
                />
              </div>
        ...
        <q-card class="shadow-1 h-full">
          ...
          <q-tab-panels v-model="tab" animated>
                ...
                <div class="col-6 grid gap-y-2">
                  ...
                  >
                    ...
                    <SeatIcon
                      :nro="(row - 1) * 4 + 2"
                      :estado="
                        row === 3 ? 'libre' : row === 4 ? 'libre' : 'ocupado'
                      "
                    />
                  </div>
                </div>
            ...
            <q-tab-panel name="nivel2">
              <div class="text-center text-grey q-pa-lg">Mapa Nivel 2</div>
            </q-tab-panel>
          </q-tab-panels>
        </q-card>
      </div>
...
const salidas = [
  {
    id: 1,
    fecha_hora: "15-06-2026 05:45 AM",
    origen: "GUA-Guatemala",
    destino: "SEP-Santa Elena, Flores",
    empresa: "PIONERA",
    itinerario: "TPB040H - Clase Oro / Esp",
    bus: "48 - TPB040F - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 2,
    fecha_hora: "15-06-2026 06:30 AM",
    origen: "GUA-Guatemala",
    destino: "QUE-Quetzaltenango",
    empresa: "PIONERA",
    itinerario: "TPB048A - Clase Oro / May",
    bus: "62 - TPB048F - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 3,
    fecha_hora: "15-06-2026 10:00 AM",
    origen: "GUA-Guatemala",
    destino: "SEP-Santa Elena, Flores",
    empresa: "PIONERA",
    itinerario: "TPB046H - Clase Oro / Esp",
    bus: "61 - TPB048F - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 4,
    fecha_hora: "15-06-2026 11:55 AM",
    origen: "GUA-Guatemala",
    destino: "EST-El Estor",
    empresa: "MAYA DE ORO",
    itinerario: "TPB046D - Starbus",
    bus: "40019 - TPB046D - Starbus",
    estado: "Iniciada",
  },
  {
    id: 5,
    fecha_hora: "15-06-2026 01:00 PM",
    origen: "GUA-Guatemala",
    destino: "SEP-Santa Elena, Flores",
    empresa: "PIONERA",
    itinerario: "TPB046H - Clase Oro / Esp",
    bus: "95 - TPB060D - Clase de O",
    estado: "Iniciada",
  },
  {
    id: 6,
    fecha_hora: "15-06-2026 03:30 PM",
    origen: "GUA-Guatemala",
    destino: "ENJ-El Naranjo",
    empresa: "PIONERA",
    itinerario: "TPB046H - Clase Oro / Esp",
    bus: "60 - TPB050F - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 7,
    ...
    empresa: "PIONERA",
    itinerario: "TPB048A - Clase Oro / May",
    bus: "71 - TPB040H - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 8,
    fecha_hora: "15-06-2026 05:55 PM",
    origen: "GUA-Guatemala",
    destino: "EST-El Estor",
    empresa: "MAYA DE ORO",
    itinerario: "TPB046D - Starbus",
  ...
  {
    id: 9,
    fecha_hora: "15-06-2026 06:00 PM",
    origen: "GUA-Guatemala",
    destino: "MDM-Melchor de Mencos",
    empresa: "PIONERA",
    itinerario: "TPB048C - Clase Oro Espe",
    bus: "64 - TPB051C - Clase Oro",
    estado: "Iniciada",
  },
  {
    id: 10,
    fecha_hora: "15-06-2026 09:00 PM",
    origen: "GUA-Guatemala",
    destino: "SEP-Santa Elena, Flores",
    empresa: "PIONERA",
    itinerario: "TPB054E - Clase Oro GLS",
    bus: "98 - TPB054E - Clase Oro",
    estado: "Iniciada",
  },
];
