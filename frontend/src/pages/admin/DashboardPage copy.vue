<template>
  <div class="dashboard">
    <div class="dashboard__header">
      <div>
        <h1 class="dashboard__title text-blue-grey-6">
          Panel de Administración
        </h1>
        <p class="dashboard__subtitle">
          Gestión y monitoreo del sistema de transporte
        </p>
      </div>
    ...
    <section class="dashboard__section">
      ...
      >
        ...
        <!-- <q-card-section> -->
        <!-- <section class="dashboard__section"> -->
        <div class="" @click="toggleSection('resumen')">
          <h2 class="dashboard__section-title">Resumen</h2>
          <icon
            :name="
              expandedSections.has('resumen') ? 'expand_less' : 'expand_more'
            "
        ...
        <v-transition>
          <div
            v-show="expandedSections.has('resumen')"
            class="dashboard__section-body"
          >
    ...
    <section class="dashboard__section">
      <q-expansion-item
        ...
        header-class="dashboard__section-header"
      >
        <!-- <section class="dashsboard__section"> -->
        ...
        <!-- </div> -->
        <div
          v-if="expandedSections.has('entities')"
          class="dashboard__section-body"
        >
          <p class="dashboard__section-desc">
            Acceda a las operaciones CRUD de cada entidad del sistema
          </p>
    ...
    <section class="dashboard__section mt-100px">
      ...
      <div
        class="dashboard__section-body"
        :class="{ collapse: !expandedSections.has('resumen') }"
      >
        <div class="stats-grid">
    ...
    <section class="dashboard__section">
      <div class="dashboard__section-header" @click="toggleSection('entities')">
        ...
        <icon
          :name="
            expandedSections.has('entities') ? 'expand_less' : 'expand_more'
          "
          class="section-chevron"
        />
      </div>
