<template>
	<div class="dashboard">
		...
		<section class="dashboard__section">
			<q-expansion-item expand-separator icon="sym_o_perm_identity" label="Resumen" caption="John Doe" header-class="dashboard__section-header">
				<!-- <q-card> -->
				<!-- <q-card-section> -->
				<!-- <section class="dashboard__section"> -->
				...
				<v-transition>
					<div v-show="expandedSections.has('resumen')" class="dashboard__section-body">
		...
		<section class="dashboard__section">
			<q-expansion-item expand-separator icon="sym_o_perm_identity" label="Gestión de Entidades" caption="John Doe" header-class="dashboard__section-header">
