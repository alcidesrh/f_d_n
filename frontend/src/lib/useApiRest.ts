...
type ApiClient = {
  request: <T = any>(cfg: RequestConfig) => Promise<T>;
  get: <T = any>(url: string, c?: any) => Promise<T>;
  post: <T = any>(url: string, data?: any, c?: any) => Promise<T>;
  put: <T = any>(url: string, data?: any, c?: any) => Promise<T>;
  patch: <T = any>(url: string, data?: any, c?: any) => Promise<T>;
  delete: <T = any>(url: string, c?: any) => Promise<T>;
...
export function createApi(options: ApiOptions): ApiClient {
  ...
  return {
    request,
    get: <T = any>(url: string, c?: any) => request<T>({ ...c, url, method: "GET" }),
    post: <T = any>(url: string, data?: any, c?: any) =>
      request<T>({ ...c, url, method: "POST", data }),
    put: <T = any>(url: string, data?: any, c?: any) =>
      request<T>({ ...c, url, method: "PUT", data }),
    patch: <T = any>(url: string, data?: any, c?: any) =>
      request<T>({ ...c, url, method: "PATCH", data }),
    delete: <T = any>(url: string, c?: any) => request<T>({ ...c, url, method: "DELETE" }),
...
const apiRest: ReturnType<typeof createApi> = createApi({
