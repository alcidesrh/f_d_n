...
export function createApi(options: ApiOptions): ApiClient {
	...
	return {
		...
		post: <T = any>(url: string, data?: any, c?: any) => request<T>({ ...c, url, method: 'POST', data }),
		put: <T = any>(url: string, data?: any, c?: any) => request<T>({ ...c, url, method: 'PUT', data }),
		patch: <T = any>(url: string, data?: any, c?: any) => request<T>({ ...c, url, method: 'PATCH', data }),
...
export let restApi: ApiClient | undefined
