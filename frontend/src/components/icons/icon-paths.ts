...
export const ICON_PATHS: Record<string, string> = {
  ...
  palette: '<circle cx="12" cy="12" r="9"/><circle cx="8.2" cy="10.5" r="1.15" fill="currentColor" stroke="none"/><circle cx="12" cy="8" r="1.15" fill="currentColor" stroke="none"/><circle cx="15.8" cy="10.5" r="1.15" fill="currentColor" stroke="none"/><circle cx="10" cy="15" r="1.15" fill="currentColor" stroke="none"/>',
  ...
  route: '<circle cx="6" cy="6" r="2.2"/><circle cx="18" cy="18" r="2.2"/><path d="M6 8.2v3.3a4 4 0 0 0 4 4h4a4 4 0 0 1 4 4"/>',
  mappin: '<path d="M12 21s-6.5-6-6.5-11A6.5 6.5 0 0 1 18.5 10c0 5-6.5 11-6.5 11z"/><circle cx="12" cy="10" r="2.3"/>',
  users: '<circle cx="9" cy="8.2" r="3.2"/><path d="M3.2 19c1.1-3.1 3.2-4.7 5.8-4.7s4.7 1.6 5.8 4.7"/><circle cx="17" cy="8.6" r="2.4"/><path d="M15.3 14.6c1.9.4 3.3 1.8 4.1 4.1"/>',
  ticket: '<path d="M3.5 8.2a1.8 1.8 0 0 1 1.8-1.8h13.4a1.8 1.8 0 0 1 1.8 1.8v2.3a1.9 1.9 0 0 0 0 3.6v2.3a1.8 1.8 0 0 1-1.8 1.8H5.3a1.8 1.8 0 0 1-1.8-1.8v-2.3a1.9 1.9 0 0 0 0-3.6z"/><line x1="9.5" y1="6.5" x2="9.5" y2="17.5" stroke-dasharray="2 2.4"/>',
  barchart: '<line x1="5" y1="20" x2="5" y2="11"/><line x1="12" y1="20" x2="12" y2="5"/><line x1="19" y1="20" x2="19" y2="14"/>',
  alert: '<path d="M12 3.5 21.5 20h-19z"/><line x1="12" y1="9.5" x2="12" y2="14"/><circle cx="12" cy="17" r=".9" fill="currentColor" stroke="none"/>',
  settings: '<circle cx="12" cy="12" r="3.2"/><path d="M12 3.5v2.3M12 18.2v2.3M20.5 12h-2.3M5.8 12H3.5M17.8 6.2l-1.6 1.6M7.8 16.2l-1.6 1.6M17.8 17.8l-1.6-1.6M7.8 7.8 6.2 6.2"/>',
  calendar: '<rect x="3.5" y="5" width="17" height="15.5" rx="2.2"/><line x1="3.5" y1="9.7" x2="20.5" y2="9.7"/><line x1="8" y1="3" x2="8" y2="6.5"/><line x1="16" y1="3" x2="16" y2="6.5"/>',
