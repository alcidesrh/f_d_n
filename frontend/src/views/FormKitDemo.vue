  ...
  <div>
    ...
    <div class="card">
      <FormKit type="form" v-model="formData" submit-label="Guardar" @submit="onSubmit">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6">
          <FormKit type="Checkbox" name="newsletter" label="Suscripción" help="Recibir novedades por correo" />
      ...
      <div class="mt-6">
        ...
        <pre class="p-4 rounded-lg bg-surface-100 text-sm overflow-auto">{{ JSON.stringify(formData, null, 2) }}</pre>
      </div>
    </div>
  </div>
</template>
