...
class MigradorIAM {
    private const BASE_ACTIONS = [
        ...
        ['recorrido.crear', 'Recorrido', 'create', 'Recorridos'],
        ['recorrido.ver', 'Recorrido', 'read', 'Recorridos'],
        ['recorrido.editar', 'Recorrido', 'update', 'Recorridos'],
        ['recorrido.cancelar', 'Recorrido', 'cancel', 'Recorridos'],
