...
class Bus extends Base
{
    ...
    #[ORM\JoinColumn(name: "copiloto_id", referencedColumnName: "id")]
    private ?Piloto $copiloto = null;
    ...
    public function setCopiloto(?Piloto $copiloto): static
    {
    ...
    public function setFechaVencimientoTarjetaOperaciones(
        ?\DateTime $fechaVencimientoTarjetaOperaciones,
    ): static {
    ...
    public function setNumeroTarjetaOperaciones(
        ?string $numeroTarjetaOperaciones,
    ): static {
